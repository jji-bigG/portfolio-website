...
function ProjectQuote({ logoImageUrl, quote, author, position }) {
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
      ...
      <figure className="relative isolate">
        ...
        <img src={logoImageUrl} alt="" className="h-12 w-auto" />
...
export default function ProjectDetailPage() {
  ...
  useEffect(() => {
    fetch(`/projects/${params.name}.json`).then((response) => {
      if (response.ok) {
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-4">
              <div className="mb-5">
                {/* {JSON.stringify(data)} */}
                {data.quotes.map((quote, quoteIdx) => (
                  <div key={quoteIdx} className="mb-5">
                    <ProjectQuote
                      logoImageUrl={quote.logoImageUrl}
                      quote={quote.quote}
                      author={quote.author}
